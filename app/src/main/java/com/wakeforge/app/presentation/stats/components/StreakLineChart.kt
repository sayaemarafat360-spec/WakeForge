    ...
    Canvas(
        ...
        drawContext.canvas.drawContext.canvas.drawContext.canvas.nativeCanvas.apply {
            yLabels.forEachIndexed { index, label ->
                ...
                drawContext.canvas.nativeCanvas.drawContext.canvas.nativeCanvas.drawText(label, paddingStart - 4.dp.toPx(), y + 3.dp.toPx(), paint)
            }
        }
        ...
        drawContext.canvas.drawContext.canvas.drawContext.canvas.nativeCanvas.apply {
            xLabelPositions.forEachIndexed { index, dataIdx ->
                ...
                drawContext.canvas.nativeCanvas.drawContext.canvas.nativeCanvas.drawText(xLabelValues[index], point.x, chartHeight - 4.dp.toPx(), paint)
            }
        }
